...
def donor_reg(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            error = "yes"
            messages.error(request, 'This Email is registered already, Try with another Email')
        ...
        if user:
            try:
                ...
                if user1.status != "pending":
                    ...
                    error = "not"
                    messages.info(request, 'Your Login Status is in Pending')
            except:
                error = "yes"
                messages.error(request, 'Invalid Credentials, Try again')
        else:
...
def donate_now(request):
    ...
    if request.method=="POST":
        ...
        try:
            ...
            error = "no"
            messages.success(request, 'Donation Collection Request Has Been Sent')
        except:
            error = "yes"
...
def volunteer_reg(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            error = "no"
            messages.success(request, 'Your registration will be Approved Soon, Thank You!')
        except:
            error = "yes"
            messages.error(request, 'This Email is registered already, Try with another Email')
...
def add_area(request):
    ...
    if request.method=="POST":
        ...
        try:
            ...
            error = "no"
            messages.success(request, 'Donation area has been added')
        except:
            error = "yes"
            messages.error(request, 'Something Went Wrong. Try again')
    d = {'error':error}
...
def edit_area(request,pid):
    ...
    if request.method=="POST":
        ...
        try:
            area.save()
            error = "no"
            messages.success(request, 'Donation area detail has been updated')
        except:
            error = "yes"
            messages.error(request, 'Something Went Wrong. Try again')
...
def donationrec_detail(request,pid):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            error = "no"
            messages.success(request, 'Donation status and delivery pics updated Successfully')
        except:
            error = "yes"
            messages.error(request, 'Something Went Wrong. Try again')
